        ...
        mainPage && (
          <div>
            <div className={styles.option_button_container}>
              ...
              <a
                href="#"
                onClick={handleButtonMenueClick}
        ...
        showMenue && (
          <>
            ...
            <div className={styles.options_container}>
              ...
              <button
                className={styles.chosen_button}
                onClick={() => handleChosenLoc("")}
              >
                Current Location
              </button>
              <p>
                The location provided by the current button is provided by your
                browser
              </p>

              {/* if an invalid location or not location is entered than only this message will display */}
              <p>
                Only valid locations supported by this webapp will appear below
              </p>
              ...
              {listOfLocations[0] != "" &&
                listOfLocations.map((value, key) => (
                  <div key={key} className={styles.chosenContainer}>
                    <button
                      className={styles.chosen_button}
                      onClick={() => handleChosenLoc(value)}
                    >
                      cityname: {value.name}
                    </button>
                    <p>
                      <b>Country: </b>
                      {value.country} ,<b>State: </b>
                      {value.state}
                    </p>
                  </div>
                ))}
